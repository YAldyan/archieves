                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php else: ?>
                            ...
                            <li><a href="<?php echo e(url('/QA/home')); ?>">Home</a></li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?php echo e(url('/show/profile')); ?>">Show</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('/add/profile')); ?>">Add</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('/QA/modify/flow')); ?>">Flow</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                    <a href="<?php echo e(url('/show/request')); ?>">Show</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('/add/request')); ?>">Add</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?php echo e(url('/show/document')); ?>">Show</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('/add/document')); ?>">Add</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?php echo e(url('/QA/project/item')); ?>">
                                            Show
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li><a href="<?php echo e(url('/PNG/home')); ?>">Home</a></li>
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" 
                                    href="#">
                                    Project <span class="caret"></span>
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?php echo e(url('/show/item')); ?>">Show</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('/add/item')); ?>">Add</a>
                                    </li>
                                </ul>
                            </li>
                            <?php elseif(Auth::user()->type == 'OPR'): ?>
                            <li><a href="<?php echo e(url('/OPR/home')); ?>">Home</a></li>
                            <?php endif; ?>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        ...
                                        <?php if(Auth::user()->type == 'PNG'): ?>
                                            <a href="<?php echo e(url('/png/user/edit')); ?>">
                                                User
                                            </a>
                                        <?php elseif(Auth::user()->type == 'QA'): ?>
                                            <a href="<?php echo e(url('/QA/user/edit')); ?>">
                                                User
                                            </a>
                                        <?php elseif(Auth::user()->type == 'OPR'): ?>
                                            <a href="<?php echo e(url('/opr/user/edit')); ?>">
                                                User
                                            </a>
                                        <?php endif; ?>     
