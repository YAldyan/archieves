...
<div class="container">
                ...
                <div class="panel-body">       
                    <table class="table table-striped" id="table">
                        ...
                        <?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $his): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <form id="upload-file" class="form-horizontal" role="form" method="post" action="<?php echo e(url('/OPR/upload/doc')); ?>"  enctype="multipart/form-data">
        									...
        									<div class="input-field col s6">
        										...
        										<input type="hidden" id="nm_arsip" name="nm_arsip" value="<?php echo e($doc->NM_ARSIP); ?>">
          										...
          										<?php if($his->UPLOAD_STAT == "OK"): ?>
                                                    <a href="/unduh_opr/<?php echo e($his-> FK_ID_ITEM); ?>/<?php echo e($his->FK_ARSIP_REQ); ?>"}}>
    ...
    <?php if($useritem->STATUS == 'OPEN'): ?>
        <div class="input-group">
            <textarea id="textarea-input-opr" class="form-control custom-control" rows="5" style="resize:none">
            </textarea>     
            <span id="textarea-button-OPR" class="input-group-addon btn btn-primary">Submit</span>
    </div>
    <?php endif; ?>
</div>
