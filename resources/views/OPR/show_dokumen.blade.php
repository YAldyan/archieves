                ...
                <div class="panel-body">       
                    <table class="table table-striped" id="table">
                        ...
                        @foreach($history as $his)
                            <form id="upload-file" class="form-horizontal" role="form" method="post" action="{{ url('/OPR/upload/doc') }}"  enctype="multipart/form-data">
        									...
        									<div class="input-field col s6">
        										...
        										<input type="hidden" id="nm_arsip" name="nm_arsip" value="{{$doc->NM_ARSIP}}">
          										...
          										@if($his->UPLOAD_STAT == "OK")
                                                    <a href="/unduh_opr/{{$his-> FK_ID_ITEM}}/{{$his->FK_ARSIP_REQ}}"}}>
                                                    {{$doc->NM_ARSIP}}
                                                    </a>
                                                @endif
        									</div>
